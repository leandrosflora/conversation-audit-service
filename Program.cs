...
builder.Services.AddSingleton<NpgsqlDataSource>(sp =>
{
    ...
    {
        // Bounded so an unreachable PostgreSQL fails fast into a 503 (design.md Decision 5)
        // instead of hanging on Npgsql's much longer defaults (15s open / 30s command).
        Timeout = 5,
        CommandTimeout = 5
    };
