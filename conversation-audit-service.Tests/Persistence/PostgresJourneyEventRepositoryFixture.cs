...
/// (not a hand-rolled test schema), so PostgresJourneyEventRepository is verified against the
/// same ops.audit_events table/seed tenant the real docker-compose stack provisions.
/// </summary>
public class PostgresJourneyEventRepositoryFixture : IAsyncLifetime
{
